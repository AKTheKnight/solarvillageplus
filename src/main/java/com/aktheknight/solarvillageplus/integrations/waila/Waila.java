...
import com.aktheknight.solarvillageplus.integrations.IIntegration;
...
public class Waila implements IIntegration {
    ...
    @Override
    public void init() {
        FMLInterModComms.sendMessage("Waila", "register", "com.aktheknight.solarvillageplus.integrations.waila.WailaTileHandler.callbackRegister");
    }
